...
- Display settings (Eco / Day Goal / Month Goal) in the summary card; click ⚙️ to open the corresponding setting
...
- Enhanced memo feature documentation (added memo guide to README and aligned save behavior description with actual implementation)
